...
<html>
	...
	<script type="text/javascript">
			function clicks(){
				...
				window.location.href="/BuildingManagement/WebContent/public/oridinaryuserregister.jsp";
	...
	<body>
    	<div id="container">
        	<div id="background">
            		<div id="word">用户登录</div><br /><hr />
            	<form action="${pageContext.request.contextPath }/OrdinaryUserLogin" method="post">
                    <div id="inputs">
