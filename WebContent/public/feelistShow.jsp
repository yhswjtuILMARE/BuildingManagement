	...
	<body>
    	<hr/>
        	...
        	<table class="table" width="100%" align="center" border="0"  cellspacing="0" cellpadding="0">
                ...
                <c:forEach var="building" items="${feelist}">
                	<tr class="tr">
	                    ...
	                    <td class="td" style="text-align:center;">${building.feelist_cash }</td>
	                    <td class="td" style="text-align:center;">
	                    	<a href="/BuildingManagement/removeFeelist?feelist_id=${building.feelist_id}">删除</a>
	                    	<a href="/BuildingManagement/rentInsert?building_id=${building.building_id}&rentperson_id=${building.rentperson_id}&feelist_id=${building.feelist_id}">确认</a>
	                    </td>
                	</tr>
                </c:forEach>
            </table>
